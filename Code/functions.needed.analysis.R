...
## Recursive add function to sum up masses for Europe ##############################################
# a and b are lists with identical structure
# numeric vectors are added element-wise
# NULL is treated as 0
recursive_add <- function(a, b) {
  if (is.list(a) && is.list(b)) {
    Map(recursive_add, a, b)
